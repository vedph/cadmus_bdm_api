    ...
    public sealed class Program
    {
        ...
        public static async Task<int> Main(string[] args)
        {
            Log.Logger = new LoggerConfiguration()
                ...
                .WriteTo.Console()
#if DEBUG
                .WriteTo.File("cadmus-bdm-log.txt", rollingInterval: RollingInterval.Day)
#endif
                .CreateLogger();

            try
            {
                Log.Information("Starting Cadmus Buondelmonti API host");
                DumpEnvironmentVars();
            ...
            {
                Log.Fatal(ex, "Cadmus Buondelmonti API host terminated unexpectedly");
